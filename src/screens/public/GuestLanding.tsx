...
const GuestLanding = () => {
    ...
    const renderHeader = () => (
        <View style={styles.header}>
            <View style={[styles.avatar, { backgroundColor: colors.inputBorderColor }]}>
                <User color={colors.grey} size={20} />
            </View>
            <View style={[styles.searchContainer, { backgroundColor: colors.inputBorderColor }]}>
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            onLayout={(e: LayoutChangeEvent) => {
                                ...
                                setMainTabMeasurements(prev => {
                                    if (prev[tab] && prev[tab].x === x && prev[tab].width === width) {
                                        return prev;
                                    }
