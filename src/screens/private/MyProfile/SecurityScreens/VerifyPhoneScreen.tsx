...
import { ChevronLeft, RefreshCcw, ClipboardPaste, Lock } from 'lucide-react-native';
            ...
            >
                ...
                >
                    ...
                    <Typography size={14} style={{ color: colors.grey, fontFamily: fonts.regular, lineHeight: 22, marginBottom: 32 }}>
                        ...
                        +91*********0, valid for <Typography size={14} style={{ color: colors.cyan, fontFamily: fonts.medium }}>10 minutes</Typography>.
                    </Typography>
